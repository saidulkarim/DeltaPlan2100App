...
import com.cegis.deltaplan2100.ui.envdis.EnvDisViewModel;
...
public class SocioEconomicFragment extends Fragment {
    private SocioEconomicViewModel socioEconomicViewModel;
    private View root;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        socioEconomicViewModel = ViewModelProviders.of(this).get(SocioEconomicViewModel.class);
        root = inflater.inflate(R.layout.fragment_socio_economic, container, false);

        //        final TextView textView = root.findViewById(R.id.text_socio_economic);
        //        socioEconomicViewModel.getText().observe(this, new Observer<String>() {
        //            @Override
        ...
        ((MainActivity) getActivity()).setToolBar(getString(R.string.mnuSocioEconomic));

        searchView = root.findViewById(R.id.socio_economic_list_search_view);
        listView = root.findViewById(R.id.socio_economic_list_items);
    ...
    private void getComponents() {
        ...
        Call<List<ModelComponentLevelTwo>> call = api.getComLevelTwo(Integer.parseInt(getResources().getString(R.string.db_mnuSocioEconomic)));
